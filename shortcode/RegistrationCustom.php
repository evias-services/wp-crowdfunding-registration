...
class RegistrationCustom extends Registration {
    ...
    public function registration_save_action() {
        ...
        $this->custom_registration_validation( $fname , $lname, $slname, $password , $rpassword, $email, $phone );
        $this->custom_complete_registration( $fname , $lname, $slname, $password , $rpassword, $email, $phone );
    }
    
    public function custom_complete_registration( $fname , $lname, $slname, $password , $rpassword, $email, $phone ) {
        global $reg_errors;
    ...
    public function custom_registration_validation( $fname , $lname, $slname, $password , $rpassword, $email, $phone ) {
        global $reg_errors;
